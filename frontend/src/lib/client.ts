...
export function Environment(name: string): BaseURL {
  return `https://${name}-booking-system-f4oi.encr.app`;
}
...
/**
 * Client is an API client for the booking-system-f4oi Encore application.
 */
...
class BaseClient {
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    this.headers = {
      ...
      "User-Agent": "booking-system-f4oi-Generated-TS-Client (Encore/v1.28.0)",
    };
